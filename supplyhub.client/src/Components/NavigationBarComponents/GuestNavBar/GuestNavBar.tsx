      ...
      <div>
        <div className="flex justify-end items-center px-4 py-0 bg-white text-sm font-medium text-black space-x-7">
          <div className="flex items-center justify-center gap-4">
            ...
            <Link to="/register" className="text-black hover:text-black no-underline">
              SIGN-IN
            </Link>
            <Link to="/login" className="text-black hover:text-black no-underline">
              LOG-IN
            </Link>
          </div>
        </div>
        <nav className="flex items-center py-2 px-4 bg-white text-black mr-2 justify-between">
          <Link to="/" className="no-underline flex items-center space-x-2">
            ...
            <span className="text-base md:text-xl lg:text-2xl text-black font-semibold p-1">SupplyHub</span>
          </Link>
          <div
              className="flex items-center justify-center space-x-2 w-full max-w-[320px] md:max-w-[420px] lg:max-w-[620px] mx-auto">
            <input
                type="text"
            ...
            <button onClick={onClick} className="text-2xl p-4">
              <Link to="search-results/text"> {/* to be replaced with actual search prompt */}

...
import user_image
    from "../../../assets/default-profile-picture-avatar-photo-placeholder-vector-illustration-default-profile-picture-avatar-photo-placeholder-vector-189495158.webp";
    ...
    return (
        <div className="flex flex-col mx-auto max-w-[1100px] w-full pb-20 p-4">
            ...
            <div className="px-[140px] pb-2 text-left">
                ...
                <p className="mb-1 text-sm text-black font-semibold">Position</p>
